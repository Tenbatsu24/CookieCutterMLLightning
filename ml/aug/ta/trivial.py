...
class TrivialMix(AugMix):
    ...
    def _original_space(
        ...
        return {
            ...
            "Brightness": (torch.linspace(0.0, 0.4, num_bins), True),
            "Color": (torch.linspace(0.0, 0.2, num_bins), True),
            "Contrast": (torch.linspace(0.0, 0.4, num_bins), True),
            "Sharpness": (torch.linspace(0.0, 0.4, num_bins), True),
            "Posterize": (
